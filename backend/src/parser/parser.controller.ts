...
export class ParserController {
   ...
   */
  private getCsvSource(file?: UploadedCsvFile): Buffer {
  ...
  @Post("productions")
  async injectProductions(@UploadedFile() file: UploadedCsvFile) {
    return this.csvInjectionService.injectProductionsCSV(
      this.getCsvSource(file),
    );
  }
  ...
  @Post("events")
  async injectEvents(@UploadedFile() file: UploadedCsvFile) {
    return this.csvInjectionService.injectEventsCSV(this.getCsvSource(file));
  }
  ...
  @Post("tags")
  async injectTags(@UploadedFile() file: UploadedCsvFile) {
    return this.csvInjectionService.injectTagsCSV(this.getCsvSource(file));
  }
  ...
  @Post("blogs")
  async injectBlogs(@UploadedFile() file: UploadedCsvFile) {
    return this.csvInjectionService.injectBlogsCSV(this.getCsvSource(file));
  }
  ...
  @Post("prices")
  async injectPrices(@UploadedFile() file: UploadedCsvFile) {
    return this.csvInjectionService.injectPricesCSV(this.getCsvSource(file));
  }
}
