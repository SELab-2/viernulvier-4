...
<template>
  <section class="w-full bg-background">
    <div class="max-w-5xl mx-auto px-4 py-6">
      ...
      <template v-else-if="loading">
        ...
        >
          ...
          >
            ...
            <div class="p-4 flex gap-3" :class="viewMode === 'grid' ? 'flex-col' : 'items-center'">
              <div v-if="viewMode === 'list'" class="w-16 h-16 bg-muted rounded-lg shrink-0" />
      ...
      >
        <component
          :is="viewMode === 'grid' ? ProductionGridViewItem : ProductionListViewItem"
