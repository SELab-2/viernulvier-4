  ...
  <div class="m-4">
    ...
    <div class="relative">
      <input
        ...
        :required="required"
        :minlength="minLength"
        class="px-4 bg-muted border border-border h-12 font-bold text-[10px] tracking-widest rounded-lg w-full outline-none hover:border-accent hover:bg-muted/70 focus:border-foreground/30 focus:bg-background placeholder:text-muted-foreground placeholder:opacity-100 dark:placeholder:opacity-90"
