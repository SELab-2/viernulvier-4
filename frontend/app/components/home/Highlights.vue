...
<template>
  <section class="bg-background w-full">
    <div class="px-6 md:px-12 lg:px-20 py-20 max-w-7xl mx-auto">
      ...
      <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12 border-b border-border pb-6">
        <h2 class="text-3xl md:text-4xl font-display font-black tracking-tight text-foreground">
          {{ t('highlights.title') }}
        </h2>
        <p class="text-base text-muted-foreground whitespace-nowrap hidden sm:block">
