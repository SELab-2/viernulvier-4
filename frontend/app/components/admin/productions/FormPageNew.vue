...
/**
 * components/admin/productions/FormPageNew.vue
 *
 * New production form architecture.
 *
 * This page is now powered by composable-based steps.
 * Each step owns its own draft/original/reset/payload logic.
 *
 * Current implementation:
 * - Step 1 fully integrated (core form)
 * - Step 2 placeholder
 * - Preview placeholder
 */
