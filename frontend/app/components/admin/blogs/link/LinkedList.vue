<!--
  components/admin/blogs/link/LinkedList.vue
  ============================================
  Scrollable list of productions linked to the blog in the current session.
      ...
      >
        ...
        <div class="flex items-center gap-3 shrink-0">
          ...
          >
            ...
            {{ unlinkingId === prod.id ? "…" : t("admin.blogs.unlinkBtn") }}
          </button>
        </div>
      </div>
    </div>
