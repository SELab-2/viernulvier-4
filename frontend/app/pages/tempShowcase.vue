  ...
  events: [
    {
      ...
      prices: [
        { id: 101, name: 'Volwassenen', price: 25.00 },
        { id: 102, name: 'Kinderen (-12)', price: 0.00 },
        { id: 103, name: 'Gezelschap', price: 0.00 },
        { id: 104, name: 'EDC-begeleider', price: 0.00 }
      ]
    },
    {
      id: 2,
      ...
      prices: [
        { id: 201, name: 'Standaard', price: 27.00 },
        { id: 202, name: 'Reductie', price: 22.00 }
      ]
    },
    {
      id: 3,
      ...
      prices: [{ id: 301, name: 'Eenheidsprijs', price: 15.00 }]
    },
    {
      id: 4,
  ...
  stories: [
    {
      ...
      description: "Een exclusieve blik achter de schermen tijdens de bouw van het reusachtige kippenhok-decor.",
      created_at: '2026-03-10T00:00:00Z'
    },
    {
      id: 2,
      titel: "INTERVIEW MET MICH WALSCHAERTS",
      description: "De regisseur over hoe je humor voor kleuters vertaalt naar een groot podium.",
...
const tags = ref([{ id: 1, tag: 'Muziek' }, { id: 2, tag: 'Familie' }])
...
const fullDescription = computed(() => cleanText(production.description1[locale.value as 'nl'|'en']) || "");
