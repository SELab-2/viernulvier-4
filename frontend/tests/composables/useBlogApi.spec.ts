...
describe("useBlogApi", () => {
  ...
  it("create calls POST /blogs with body", () => {
    ...
    const body = { titel: { nl: "Test", en: "Test" }, description: { nl: "Desc", en: "Desc" } };
    create(body);
  ...
  it("replace calls PUT /blogs/:id with body", () => {
    ...
    const body = { id: 1, titel: { nl: "Updated", en: "Updated" }, description: { nl: "Desc", en: "Desc" }, created_at: "", updated_at: "" };
    replace(1, body);
  ...
  it("modify calls PATCH /blogs/:id with body", () => {
    ...
    expect(mockPatch).toHaveBeenCalledWith("/blogs/1", { titel: { nl: "Patched", en: "Patched" } });
  });
